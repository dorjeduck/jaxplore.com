...
square_size = (img_width - 6 * (len(text) + 1) * spacing) // (3 * len(text))
img_height = 5 * (square_size + spacing) - spacing  # Height based on 5 rows and spacing
...
def get_letter_grid(letter):
    grids = {
        ...
        "G": [(0, 1), (0, 2), (1, 0), (2, 0), (2, 1), (2, 2), (3, 0), (4, 1), (4, 2)],
        "H": [
            (0, 0),
            (0, 2),
            (1, 0),
...
y_offset = (img_height - (5 * square_size + 4 * spacing)) // 2  # Vertical centering
